...
@section('main')
    ...
    <admin-title-box
        ...
        <template slot="header">
            <span class="title-box__title">메뉴 옵션</span>
        ...
        <table class="table__list">
            ...
            <tbody v-if="isObject">
                <tr v-for="(_group, index) in groups">
                    ...
                    <td class="left">
                        <a :href="'option/' + _group.id">@{{ _group.title }}</a>
                    </td>
                    <td>
        ...
        new Vue({
            ...
            methods: {
                ...
                ajax(page = 1) {
                    ...
                    axios.get(`/api/admin/vendor/${this.vendor_id}/menu/option`, {
                        params: {
                            page: page,
                ...
                updateMenu(id) {
                    ...
                    location.href = `/admin/vendor/${this.vendor_id}/menu/option/${menu.id}/edit`;
                },
                deleteMenu(id) {
                    ...
                    if (confirm(`'${menu.title}' 메뉴를 삭제하시겠습니까?`)) {
                        ...
                        axios.delete(`/api/admin/vendor/${this.vendor_id}/option/menu/${menu.id}`)
                            .then(function (response) {
                ...
                recoveryMenu(id) {
                    ...
                    if (confirm(`'${menu.title}' 메뉴를 복구하시겠습니까?`)) {
                        ...
                        axios.post(`/api/admin/vendor/${this.vendor_id}/menu/option/${menu.id}/recovery`, form, {
                            headers: {
                ...
                updateActive(id, value) {
                    ...
                    axios.post(`/api/admin/vendor/${this.vendor_id}/menu/option/${menu_id}/active`, form, {
                            headers: {
                                'X-HTTP-Method-Override': 'PUT'
                            }
                        })
                ...
                updateRecommend(id, value) {
                    ...
                    axios.post(`/api/admin/vendor/${this.vendor_id}/menu/option/${menu_id}/recommend`, form, {
                        headers: {
                            'X-HTTP-Method-Override': 'PUT'
                        }
                    })
