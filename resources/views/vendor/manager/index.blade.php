...
@section('main')
    ...
    <admin-title-box
        ...
        <template slot="header">
            ...
            <span class="title-box__today responsive--hidden">( {{ \App\Helpers\StringHelper::statistics($roles) }} )</span>
        </template>
    </admin-title-box>
                ...
                <table>
                    ...
                    <tbody v-if="isObject">
                        <tr v-for="(_user, index) in users">
                            ...
                            <td class="btn__list" v-if="_user.role == 'veondor_administrator' || _user.id == '{{ $vendor->id }}'">-</td>
        ...
        new Vue({
            ...
            methods: {
                ...
                ajax(page = 1) {
                    ...
                    axios.get("{{ route('api.vendor.manager.index') }}", {
                        params: {
                            page: page,
                ...
                deleteManager(id) {
                    if (confirm('관리자를 삭제하시겠습니까?')) {
                        ...
                        axios.delete("/api/vendor/manager/" + id)
                            .then(function (response) {
                ...
                recoveryManager(id, email) {
                    if (confirm('관리자를 복구하시겠습니까?')) {
                        ...
                        axios.post("/api/vendor/manager/recovery/email", form, {
                            headers: {
