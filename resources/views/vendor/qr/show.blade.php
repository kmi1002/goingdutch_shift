...
@section('main')
    ...
    <admin-title-box
        ...
        <template slot="header">
            <span class="title-box__title">QR 메뉴</span>
        ...
        <table class="table__list">
            ...
            <tbody v-if="isObject">
                <tr v-for="(_menu, index) in menus">
                    ...
                    <td class="left" v-text="_menu.title"></td>
                    ...
                    <td class="btn__list">
                        <button type="button" class="btn__item btn__item--red" @click="updateActive(index, false)" v-if="_menu.active">On</button>
                        <button type="button" class="btn__item" @click="updateActive(index, true)" v-else>Off</button>
                    </td>
                    <td class="btn__list">
                        <button type="button" class="btn__item btn__item--red" @click="updateRecommend(index, false)" v-if="_menu.recommend">On</button>
                        <button type="button" class="btn__item" @click="updateRecommend(index, true)" v-else>Off</button>
                    </td>
        ...
        new Vue({
            ...
            methods: {
                ...
                updateMenu(id) {
                    ...
                    this.$modal.show('admin-vendor-modal-create', { apiUrl : '/api/admin/vendor', vendor : user  });
                },
                deleteMenu(id) {
                    ...
                    if (confirm(user.vendor.vendor + ' 메뉴를 삭제하시겠습니까?')) {
                        ...
                        axios.delete("/api/admin/vendor/" + user.user.id)
                            .then(function (response) {
