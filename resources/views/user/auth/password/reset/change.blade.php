...
@section('main')
    ...
    <section class="auth">
        <div class="auth__container">
            <form method="post" action="{{ route('user.auth.password.reset') }}" id="change_password-form" v-on:submit="onSubmit">
                {{ csrf_field() }}
                ...
                <div class="auth-body">
                    <div class="input-field">
                        <label>
                            {{--<input type="password" name="old_password" class="user-pass" value="" required v-model="old_password">--}}
                            <vue-password
                    ...
                    <div class="input-field">
                        <label>
                            {{--<input type="password" name="password" class="user-pass" value="" required v-model="password">--}}
                            <vue-password
                                    v-model="password"
                                    classes="input"
                                    name="password"
                    ...
                    <div class="input-field">
                        <label>
                            {{--<input type="password" name="password_confirmation" class="user-pass-confirm" value="" required v-model="password_confirmation">--}}
                            <vue-password
